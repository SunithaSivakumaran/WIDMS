...
<div class="admin-shell">
    ...
    <main class="dashboard-content">
        ...
        <section class="stats-grid" aria-label="Store Keeper statistics">
            <a class="stat-card stat-card-link" href="dashboard.php?page=approved-dispatches"><span class="stat-icon">📥</span><p>Items to Dispatch</p><strong><?= $itemsToDispatch ?></strong><small><?= $itemsToDispatch > 0 ? 'Approved, awaiting release' : 'No approved requests waiting' ?></small><span class="stat-card-action"><?=htmlspecialchars(t('View details'),ENT_QUOTES,'UTF-8')?> <span aria-hidden="true">&#8594;</span></span></a>
